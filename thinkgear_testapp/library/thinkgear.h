...
/* chear: add for BMD200 for 599's pocket*/
#define TG_DATA_RAW_LAST_MARK      13
#define TG_DATA_CON_OUT_4			14
#define TG_DATA_COU_OUT_3			15
...
/**
 * Sends a Array of bytes through the ThinkGear Connection (presumably to a ThinkGear
 * module) same as TG_SendByte().  This function is intended for advanced ThinkGear Command Byte
 * operations.
 *
 * WARNING: Always make sure at least one valid Packet has been read (i.e.
 *          through the @c TG_ReadPackets() function) at some point BEFORE
